...
$(document).ready(function(){
	...
	//Start video adaptation
		//Set main video
			// window.MAIN_VIDEO_URL = '<iframe id="video" src="https://www.youtube.com/embed/qJmTbhC1O3s" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
			...
			// <div class="col-md-3 col-sm-6 col-xs-6" data-id="47911018" data-source="vimeo">
            //         <img src="img/portfolio/video-preview-1.jpg" class="thumbnail-video" alt="video-preview-8">
            // </div>
			
			// <div class="col-md-3 col-sm-6 col-xs-6 active" data-id="qJmTbhC1O3s" data-source="youtube">
            //         <img src="img/portfolio/video-preview-8.jpg" class="thumbnail-video" alt="video-preview-1">
            // </div>


		//Get video container width
			// window.CURRENT_VIDEO_ID = 'qJmTbhC1O3s';
